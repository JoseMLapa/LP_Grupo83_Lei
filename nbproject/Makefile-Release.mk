...
${OBJECTDIR}/API_GestaoUser.o: API_GestaoUser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API_GestaoUser.o API_GestaoUser.c
...
${OBJECTDIR}/API_Menus.o: API_Menus.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API_Menus.o API_Menus.c
...
${OBJECTDIR}/Gestao_User.o: Gestao_User.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gestao_User.o Gestao_User.c
